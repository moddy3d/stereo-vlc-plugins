    ...
    if (supports_fp) {
        ...
        if (need_fs_yuv) {
            ...
            const char *template_yuv =
                    ...
                    // Move fragment coordinates to temporary variable

                    "TEMP coord;"
                    "MOV coord.x, fragment.position.x;"
                    "MOV coord.y, fragment.position.y;"
                    
                    // Fractions
                    "TEMP thirds;"
                    "MOV thirds.x, 0.3333333333333333;" // one third
                    "MOV thirds.y, 0.6666666666666666;" // two thirds
                    
                    "TEMP eighths;"
                    "MOV eighths.x, 0.125;" // one eighths
                    "MOV eighths.y, 0.375;" // three eighths
                    "MOV eighths.z, 0.625;" // five eighths
                    "MOV eighths.w, 0.750;" // six eighths
                    
                    // Calculate vertical
                    //"MUL coord.y, coord.y, 3.0;"
                    "MUL coord.y, coord.y, 0.08332606;"
                    "MOV coord.z, coord.y;"
                    "FLR coord.z, coord.z;"
                    "SUB coord.y, coord.y, coord.z;"
                    "ABS coord.y, coord.y;"
                    "MUL coord.y, coord.y, 12.0010461823;"
                    "MUL coord.y, coord.y, 0.6666085;" 
                    "FLR coord.y, coord.y;"
                    //"MUL coord.y, coord.y, -1.0;"
                    
                    // Calculate Horizontal
                    "MUL coord.x, coord.x, 3.0;"
                    "ADD coord.x, coord.x, 7.0;"
                    "ADD coord.x, coord.x, -coord.y;"
                    "MUL coord.x, coord.x, eighths.x;"
                    "MOV coord.z, coord.x;"
                    "FLR coord.z, coord.z;"
                    "SUB coord.x, coord.x, coord.z;"
                    "ABS coord.x, coord.x;"
                    "MUL coord.x, coord.x, 8.0;"
                    "ADD coord.x, coord.x, 1.0;"
                    
                    // Views R, G, B
                    "TEMP views;"
                    "TEMP tempv;"
                    "ADD views.r, coord.x, 0.0;"
                    
                    "ADD views.g, coord.x, 1.0;"
                    "ADD tempv.g, views.g, -10.0;"
                    "CMP views.g, tempv.g, views.g, 1.0;"
                   
                    "ADD views.b, coord.x, 1.0;"
                    "ADD tempv.b, views.b, -10.0;"
                    "CMP views.b, tempv.b, views.b, 1.0;"
                    
                    "ADD views.b, views.b, 1.0;"
                    "ADD tempv.b, views.b, -10.0;"
                    "CMP views.b, tempv.b, views.b, 1.0;"
                    
                    // Conditional Flags (x = flag, y = expression)
                    "TEMP is1to3;"
                    "TEMP is4to6;"
                    "TEMP is7to8;"
                    "TEMP is7;"
                    ...
                    "ADD is1to3.y, views.r, -1.0;"
                    "CMP is1to3.x, is1to3.y, -1.0, 1.0;"
                    "ADD is4to6.y, views.r, -4.0;"
                    "CMP is4to6.x, is4to6.y, -1.0, 1.0;"
                    
                    "ADD is7.y, views.r, -7.0;"
                    "CMP is7.x, is7.y, -1.0, 1.0;"
                    "ADD is8.y, views.r, -8.0;"
                    "CMP is8.x, is8.y, -1.0, 1.0;"
                    
                    "CMP is1to3.x, is8.x, is1to3.x, 0.0;"
                    "CMP is1to3.x, is7.x, is1to3.x, 0.0;"
                    "CMP is1to3.x, is4to6.x, is1to3.x, 0.0;"
                    "CMP is1to3.x, is1to3.x, 0.0, is1to3.x;"
                    "CMP is4to6.x, is8.x, is4to6.x, 0.0;"
                    "CMP is4to6.x, is7.x, is4to6.x, 0.0;"
                    "CMP is4to6.x, is4to6.x, 0.0, is4to6.x;"
                    "CMP is7.x, is8.x, is7.x, 0.0;"
                    "CMP is7.x, is7.x, 0.0, is7.x;"
                    "CMP is8.x, is8.x, 0.0, is8.x;"
                    
                    "MOV is7bot, fragment.texcoord[0];"
                    "ADD is7bot.y, is7bot.y, -thirds.x;"
                    "CMP is7top.x, is7bot.y, 1.0, 0.0;"
                    "CMP is7bot.x, is7bot.y, 0.0, 1.0;"
                    
                    "MOV is8bot, fragment.texcoord[0];"
                    "ADD is8bot.y, is8bot.y, -thirds.y;"
                    "CMP is8top.x, is8bot.y, 1.0, 0.0;"
                    "CMP is8bot.x, is8bot.y, 0.0, 1.0;"
                    
                    // Accumulate sampling offsets
                    // 1 to 3
                    "MOV a1to3, fragment.texcoord[0];"
                    "MUL a1to3.x, a1to3.x, thirds.x;"
                    "MUL a1to3.y, a1to3.y, eighths.y;"
                    "MOV a1to3.z, views.r;"
                    "ADD a1to3.z, a1to3.z, -1.0;"
                    "MUL a1to3.z, a1to3.z, thirds.x;"
                    "ADD a1to3.x, a1to3.x, a1to3.z;"
                    //"ADD a1to3.x, a1to3.x, -0.16666666666666;" // NATIVE FIX
                    // CONDITIONAL
                    "MUL a1to3.x, a1to3.x, is1to3.x;"
                    "MUL a1to3.y, a1to3.y, is1to3.x;"
                    
                    // 4 to 6
                    "MOV a4to6, fragment.texcoord[0];"
                    "MUL a4to6.x, a4to6.x, thirds.x;"
                    "MUL a4to6.y, a4to6.y, eighths.y;"
                    "ADD a4to6.y, a4to6.y, eighths.y;"
                    "MOV a4to6.z, views.r;"
                    "ADD a4to6.z, a4to6.z, -4.0;"
                    "MUL a4to6.z, a4to6.z, thirds.x;"
                    "ADD a4to6.x, a4to6.x, a4to6.z;"
                    //"ADD a4to6.x, a4to6.x, -0.16666666666666;" // NATIVE FIX
                    // CONDITIONAL
                    "MUL a4to6.x, a4to6.x, is4to6.x;"
                    "MUL a4to6.y, a4to6.y, is4to6.x;"
                    
                    // 7 top
                    "MOV a7top, fragment.texcoord[0];"
                    "MUL a7top.x, a7top.x, thirds.x;"
                    "ADD a7top.x, a7top.x, thirds.x;"
                    "MUL a7top.y, a7top.y, eighths.y;"
                    "ADD a7top.y, a7top.y, eighths.w;"
                    // CONDITIONAL
                    "MUL a7top.x, a7top.x, is7top.x;"
                    "MUL a7top.y, a7top.y, is7top.x;"
                    "MUL a7top.x, a7top.x, is7.x;"
                    "MUL a7top.y, a7top.y, is7.x;"
                    
                    // 7 bot
                    "MOV a7bot, fragment.texcoord[0];"
                    "MUL a7bot.x, a7bot.x, thirds.x;"
                    "MUL a7bot.y, a7bot.y, eighths.y;"
                    "ADD a7bot.y, a7bot.y, eighths.z;"
                    // CONDITIONAL
                    "MUL a7bot.x, a7bot.x, is7bot.x;"
                    "MUL a7bot.y, a7bot.y, is7bot.x;"
                    "MUL a7bot.x, a7bot.x, is7.x;"
                    "MUL a7bot.y, a7bot.y, is7.x;"
                    
                    // 8 top
                    "MOV a8top, fragment.texcoord[0];"
                    "MUL a8top.x, a8top.x, thirds.x;"
                    "ADD a8top.x, a8top.x, thirds.y;"
                    "MUL a8top.y, a8top.y, eighths.y;"
                    "ADD a8top.y, a8top.y, eighths.w;"
                    // CONDITIONAL
                    "MUL a8top.x, a8top.x, is8top.x;"
                    "MUL a8top.y, a8top.y, is8top.x;"
                    "MUL a8top.x, a8top.x, is8.x;"
                    "MUL a8top.y, a8top.y, is8.x;"
                    
                    // 8 bot
                    "MOV a8bot, fragment.texcoord[0];"
                    "MUL a8bot.x, a8bot.x, thirds.x;"
                    "ADD a8bot.x, a8bot.x, thirds.x;"
                    "MUL a8bot.y, a8bot.y, eighths.y;"
                    "ADD a8bot.y, a8bot.y, eighths.z;"
                    // CONDITIONAL
                    "MUL a8bot.x, a8bot.x, is8bot.x;"
                    "MUL a8bot.y, a8bot.y, is8bot.x;"
                    "MUL a8bot.x, a8bot.x, is8.x;"
                    "MUL a8bot.y, a8bot.y, is8.x;"
                    
                    // Accumulate all RED sampling
                    "TEMP rsamp;"
                    "MOV rsamp.xyzw, 0.0;"
                    "ADD rsamp, rsamp, a1to3;"
                    "ADD rsamp, rsamp, a4to6;"
                    "ADD rsamp, rsamp, a7top;"
                    "ADD rsamp, rsamp, a8top;"
                    "ADD rsamp, rsamp, a7bot;"
                    "ADD rsamp, rsamp, a8bot;"
                    
                    ///////////////////
                    // G conditional //
                    ///////////////////
                    
                    "ADD is1to3.y, views.g, -1.0;"
                    "CMP is1to3.x, is1to3.y, -1.0, 1.0;"
                    "ADD is4to6.y, views.g, -4.0;"
                    "CMP is4to6.x, is4to6.y, -1.0, 1.0;"
                    
                    "ADD is7.y, views.g, -7.0;"
                    "CMP is7.x, is7.y, -1.0, 1.0;"
                    "ADD is8.y, views.g, -8.0;"
                    "CMP is8.x, is8.y, -1.0, 1.0;"
                    ...
                    "MOV is7bot, fragment.texcoord[1];"
                    "ADD is7bot.y, is7bot.y, -thirds.x;"
                    "CMP is7top.x, is7bot.y, 1.0, 0.0;"
                    "CMP is7bot.x, is7bot.y, 0.0, 1.0;"
                    
                    "MOV is8bot, fragment.texcoord[1];"
                    "ADD is8bot.y, is8bot.y, -thirds.y;"
                    "CMP is8top.x, is8bot.y, 1.0, 0.0;"
                    "CMP is8bot.x, is8bot.y, 0.0, 1.0;"
                    ...
                    // Accumulate all GREEN sampling
                    "TEMP gsamp;"
                    "MOV gsamp.xyzw, 0.0;"
                    "ADD gsamp, gsamp, a1to3;"
                    "ADD gsamp, gsamp, a4to6;"
                    "ADD gsamp, gsamp, a7top;"
                    "ADD gsamp, gsamp, a8top;"
                    "ADD gsamp, gsamp, a7bot;"
                    "ADD gsamp, gsamp, a8bot;"
                    
                    ///////////////////
                    // B conditional //
                    ///////////////////
                    
                    "ADD is1to3.y, views.b, -1.0;"
                    "CMP is1to3.x, is1to3.y, -1.0, 1.0;"
                    "ADD is4to6.y, views.b, -4.0;"
                    "CMP is4to6.x, is4to6.y, -1.0, 1.0;"
                    
                    "ADD is7.y, views.b, -7.0;"
                    "CMP is7.x, is7.y, -1.0, 1.0;"
                    "ADD is8.y, views.b, -8.0;"
                    "CMP is8.x, is8.y, -1.0, 1.0;"
                    ...
                    "MOV is7bot, fragment.texcoord[2];"
                    "ADD is7bot.y, is7bot.y, -thirds.x;"
                    "CMP is7top.x, is7bot.y, 1.0, 0.0;"
                    "CMP is7bot.x, is7bot.y, 0.0, 1.0;"
                    
                    "MOV is8bot, fragment.texcoord[2];"
                    "ADD is8bot.y, is8bot.y, -thirds.y;"
                    "CMP is8top.x, is8bot.y, 1.0, 0.0;"
                    "CMP is8bot.x, is8bot.y, 0.0, 1.0;"
                    ...
                    "TEMP bsamp;"
                    "MOV bsamp.xyzw, 0.0;"
                    "ADD bsamp, bsamp, a1to3;"
                    "ADD bsamp, bsamp, a4to6;"
                    "ADD bsamp, bsamp, a7top;"
                    "ADD bsamp, bsamp, a8top;"
                    "ADD bsamp, bsamp, a7bot;"
                    "ADD bsamp, bsamp, a8bot;"
                    
                    // Sample from texture based on R, G, B sampling
                    "TEMP rgbclr;"           
                    "TEMP src;"
                    "TEX src.x,  rsamp, texture[0], 2D;"
                    "TEX src.%c, rsamp, texture[1], 2D;"
                    "TEX src.%c, rsamp, texture[2], 2D;"
                    ...
                    "MAD  tmp.rgb,          src.zzzz, coefficient[2], tmp;"
                    "MOV rgbclr.r, tmp.r;"
                    
                    "TEX src.x,  gsamp, texture[0], 2D;"
                    "TEX src.%c, gsamp, texture[1], 2D;"
                    "TEX src.%c, gsamp, texture[2], 2D;"
                    ...
                    "TEX src.x,  bsamp, texture[0], 2D;"
                    "TEX src.%c, bsamp, texture[1], 2D;"
                    "TEX src.%c, bsamp, texture[2], 2D;"
